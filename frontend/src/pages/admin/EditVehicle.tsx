...
const EditVehicle = () => {
  ...
  if (isFetching) return <div className="p-12 text-center text-secondary animate-pulse">Loading vehicle data...</div>;
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="flex justify-between items-center">
        <div>
          <Title level={2} className="mb-0 text-primary">Edit Vehicle</Title>
          <p className="text-secondary">Update details for {vehicle?.make} {vehicle?.model}</p>
        </div>
      </div>
